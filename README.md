...
Follow these steps to connect the frontend dashboard to the Google Apps Script backend.
...
Remove any default code.

---

## 3. Add Backend Scripts

Create two script files:

### code.gs

Paste the contents of the project’s `code.gs` file.

### alertengine.gs

Add a second file and paste the contents of `alertengine.gs`.
...
Authorize permissions and deploy.
...
Replace the API URL with your deployment endpoint.
...
To allow automatic updates and alerts:

Open **Apps Script → Triggers**

Create two time-driven triggers.
